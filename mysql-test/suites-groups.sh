...
WORKER_4_MTR_SUITES="audit_log,binlog_57_decryption,percona-pam-for-mysql,data_masking,procfs,rpl_encryption,tokudb,tokudb_add_index,tokudb_alter_table,tokudb_bugs,tokudb_parts,tokudb_perfschema,tokudb_rpl,audit_null,engines/iuds,engines/funcs,group_replication,jp,stress"
...
check() {
  ...
  # get rid of big/nobig before two-way matching
