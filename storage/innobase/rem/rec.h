...
static ALWAYS_INLINE void rec_init_offsets_comp_ordinary(const rec_t *rec, bool temp,
...
#if 0 // KH: disable this optimization (doesn't seem to be critical. it is better to inline this function)
  if  (rec_insert_state == INSERTED_INTO_TABLE_WITH_NO_INSTANT_NO_VERSION) {
    do {
...
#endif // KH: disable this optimization
  {
