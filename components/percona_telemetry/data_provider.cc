...
static inline const char *b2s(bool val) { return val ? "1" : "0"; }
...
bool DataProvider::collect_db_instance_id_info(rapidjson::Document *document) {
  ...
  document->AddMember(rapidjson::StringRef("db_instance_id"), instance_id,
                      allocator);
  return false;
}
bool DataProvider::collect_product_version_info(rapidjson::Document *document) {
  ...
  document->AddMember(rapidjson::StringRef("pillar_version"), version, allocator);
  return false;
}
...
bool DataProvider::collect_plugins_info(rapidjson::Document *document) {
  ...
  document->AddMember(rapidjson::StringRef("active_plugins"), plugins,
                      allocator);
...
bool DataProvider::collect_components_info(rapidjson::Document *document) {
  ...
  document->AddMember(rapidjson::StringRef("active_components"), components,
                      allocator);
  return false;
}
...
bool DataProvider::collect_uptime_info(rapidjson::Document *document) {
  ...
  document->AddMember(rapidjson::StringRef("uptime"), uptime, allocator);
  return false;
}
...
bool DataProvider::collect_dbs_number_info(rapidjson::Document *document) {
  ...
  document->AddMember(rapidjson::StringRef("databases_count"), db_cnt,
                      allocator);
  return false;
}
...
bool DataProvider::collect_dbs_size_info(rapidjson::Document *document) {
  ...
  document->AddMember(rapidjson::StringRef("databases_size"), db_size,
                      allocator);
  return false;
}
...
bool DataProvider::collect_se_usage_info(rapidjson::Document *document) {
  ...
  document->AddMember(rapidjson::StringRef("se_engines_in_use"), se_engines,
                      allocator);
  return false;
}
...
bool DataProvider::collect_group_replication_info(
  ...
  if (result.size() > 0) {
    ...
    gr_json.AddMember(rapidjson::StringRef("role"), role, allocator);
    ...
    gr_json.AddMember(rapidjson::StringRef("single_primary_mode"),
    ...
    if (!do_query(
      ...
      gr_json.AddMember(rapidjson::StringRef("group_size"), group_size,
                        allocator);
    }

    document->AddMember(rapidjson::StringRef("group_replication_info"), gr_json,
                        allocator);
  }
  return false;
}
...
bool DataProvider::collect_async_replication_info(
  ...
  if (is_source || is_replica || is_semisync_source || is_semisync_replica) {
    ...
    if (is_semisync_source) {
      ...
      r_json.AddMember(rapidjson::StringRef("is_semisync_source"),
                       is_semisync_source_json, allocator);
    } else if (is_source) {
      rapidjson::Value is_source_json;
      is_source_json.SetString(b2s(is_source), allocator);
      r_json.AddMember(rapidjson::StringRef("is_source"), is_source_json,
                       allocator);
    }
    ...
    if (is_semisync_replica) {
      ...
      r_json.AddMember(rapidjson::StringRef("is_semisync_replica"),
                       is_semisync_replica_json, allocator);
    } else if (is_replica) {
      rapidjson::Value is_replica_json;
      is_replica_json.SetString(b2s(is_replica), allocator);
      r_json.AddMember(rapidjson::StringRef("is_replica"), is_replica_json,
                       allocator);
    }
    ...
    document->AddMember(rapidjson::StringRef("replication_info"), r_json,
                        allocator);
  }
